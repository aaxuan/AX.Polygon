...
namespace AX.Polygon.WebCore
{
    ...
    public class BaseController : Controller
    {
        ...
        public IActionResult SuccessResultMessage(string message)
        {
            return new JsonResult(new Util.JsonResultMessage() { Code = 1, Message = message });
        }

        public IActionResult SuccessResultMessage<T>(T data)
        {
            return new JsonResult(new Util.JsonResultMessage<T>() { Code = 1, Message = "请求成功", Data = data });
        }
    }
}
